 ...
 **/
public interface FiltreSysMessageDataSourceRepository extends JpaRepository<FiltreSysMessageDataSource, Long> {
    List<FiltreSysMessageDataSource> findAllByMessageDataSourceId(Long messageDataSource_id);
}
